...
$themeReplace['description'] = <<<OUT
   <p><b>This is a private proxy for the use of friends of darthmorf (AKA Sam Poirier) only</b>. <br>Please be considerate when using - this is not intended for intensive activities! <br> Thanks.</p>
OUT;
